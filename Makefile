...
ALL_UGLY = db/ETCBC4.da.prop.json db/ETCBC4.pt.prop.json db/ETCBC4.db.json db/ETCBC4.en.prop.json \
	db/ETCBC4-translit.da.prop.json db/ETCBC4-translit.pt.prop.json \
	db/ETCBC4-translit.db.json db/ETCBC4-translit.en.prop.json db/ETCBC4.typeinfo.json \
	db/nestle1904.da.prop.json db/nestle1904.pt.prop.json \
