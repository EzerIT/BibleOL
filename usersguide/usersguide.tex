...
\emph{NmCl} (nominal clause), or \emph{Ptcp} (participle clause).}{\emph{object, indirect
    object,} or \emph{second object.}}\footnote{The answer \emph{Other value} is not relevant in this
...
next clause in the sentence, which is \HOrG{#1}{}{simply the word} \HOrG{#1}{\heb{וְהִ֖וא בְּעֻ֥לַת בָּֽעַל}}{ἡμῖν}.
