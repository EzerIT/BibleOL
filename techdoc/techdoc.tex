...
\usepackage{xcolor}
\usepackage{graphicx}
\usepackage{longtable}[=v4.13]% See https://tex.stackexchange.com/questions/600724/dimension-too-large-after-recent-longtable-update
\usepackage{tabu}
\usepackage{multirow}
\usepackage{capt-of}
...
License\footnote{\url{https://opensource.org/licenses/MIT}}. The code is Copyright © 2022 by Claus
