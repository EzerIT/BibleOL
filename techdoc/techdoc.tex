...
xThere is a one-to-one mapping of classes and data fields in the server and in the client, but the
...
helpers/quiztemplate\_helper & XML parser for quiz template files.\\
