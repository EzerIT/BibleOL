...
\index{localization JavaScript variable@\emph{localization} JavaScript variable|hyperit}
...
\begin{my-longtabu}{lX}{ \headii{Variable}{Contents} }
  ...
  localization\hmmindex{localization JavaScript variable@\string\emph{localization} JavaScript variable} &
