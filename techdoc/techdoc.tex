...
\renewcommand{\preindexhook}{Page numbers in italics are used to indicate the main reference for an entry.
\vspace{1cm}
}
...
the name of the Database Localization Files (see Section \ref{sec-db-local}) for the superset.
...
libraries/include/typeinfo.inc & The \emph{TypeInfo} class (see Section \ref{sec-tif}).\\
