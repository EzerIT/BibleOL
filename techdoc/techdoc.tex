...
Note: Throughout this document the PHP command line tool is referred to as \texttt{php5.6}\index{php5.6}
...
Initialize the contents of the database from the values in the files \texttt{bolsetup.sql} and \texttt{bolsetup2.sql}.
