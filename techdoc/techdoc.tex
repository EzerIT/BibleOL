...
apache2      & php-curl & php-mbstring \\ 
mysql-client & php-dev  & php-mysql    \\ 
mysql-server & php-intl & php-sqlite3  \\ 
php          & php-json & git          \\ 
\end{tabu}
\end{center}
...
\begin{lstlisting}[language=bash]
  sudo apt install nodejs npm node-lessc node-typescript
  npm install @types/bootstrap@4.5.0 @types/jquery @types/jqueryui
\end{lstlisting}

An alternative to installing \emph{node-lessc} and \emph{node-typescript} in this manner would be to
