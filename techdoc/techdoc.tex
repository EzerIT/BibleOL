...
grading    & Boolean & \emph{True} if this entry is to be used by Learning Journey for grading
...
\subsection{The \emph{db\_localize} Table}\label{sec-db-localize}\index{db\_localize table|hyperit}

The \emph{db\_localize} table contains the Grammar Localization Structures\index{Grammar
  Localization Structure}, that is, the translation of grammar terms into various languages. For details, see
Section \ref{sec-gram-loc-struct}.
...
\subsection{The \emph{language\_LANG} Tables}\label{sec-language-lang}\index{language\_LANG table|hyperit}
...
\subsection{The \emph{lexicon\_heb} Table}\label{sec-lexicon-heb}\index{lexicon\_heb table|hyperit}

The \emph{lexicon\_heb} table contains information about all the Hebrew and Aramaic lexemes used by
the system.
...
language                & Enumeration & ``Hebrew'' or ``Aramaic''. \\
...
An entry is uniquely defined by its \emph{lex, vs,} and \emph{language} fields.

\subsection{The \emph{lexicon\_heb\_LANG} Table}\label{sec-lexicon-heb-lang}\index{lexicon\_heb\_LANG table|hyperit}

The system contains a number of tables with names such as \emph{lexicon\_heb\_en} for English,
\emph{lexicon\_heb\_de} for German. They provide translations for the lexemes listed in the
\emph{lexicon\_heb} table.

The tables contain these fields:

\begin{my-longtabu}{>{\itshape}llX}{ \headiii{\textup{Column}}{Type}{Contents} }
id      & Integer & Unique number identifying this entry. \\
lex\_id & Integer & The \emph{id} field of the entry in the \emph{lexicon\_heb} table for
...
\subsection{The \emph{lexicon\_greek\_LANG} Table}\label{sec-lexicon-greek-lang}\index{lexicon\_greek\_LANG table|hyperit}
