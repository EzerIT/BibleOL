...
\indexw{quiz template}\index{template} & A file located in the \texttt{quizzes} directory. In XML format it describes how Bible
...
What you need to do, depends on what you mean by ``installing'' Bible OL. If you want to set up a
server that runs Bible OL for the benefit of researchers and students, follow the instructions in
Section \ref{sec-host} below.

If you want to get your own copy of Bible OL in order to enhance or modify it, follow the
instructions in Section \ref{sec-devel} below.
...
You will also need to install the Emdros database system. This is probably the most complex part of
