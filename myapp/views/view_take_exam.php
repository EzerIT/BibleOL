...
<div>
<object id="quiz_frame" data='/text/show_quiz?quiz=<?= str_replace("+", "%2B", str_replace("/", "%2F", array_shift($exercises))) ?>&exam_attempt_id=<?= $exam_attempt_id ?>&exercise_lst=<?= str_replace("+", "%2B", str_replace("/", "%2F", implode("~",$exercises))) ?>' width="100%" height="auto" onLoad="loaded()" onclick="frameClick()">
</object>
</div>
