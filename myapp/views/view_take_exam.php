...
<div>
<object id="quiz_frame" data='/text/show_quiz?quiz=<?= rawurlencode(array_shift($exercises)) ?>&exam_attempt_id=<?= $exam_attempt_id ?>&exercise_lst=<?= rawurlencode(implode("~",$exercises)) ?>' width="100%" height="auto" onLoad="loaded()" onclick="frameClick()">
</object>
</div>
