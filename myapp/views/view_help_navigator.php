...
$menu = array(
    ...
    'TOHFL/Hebrew course' => array('tohfl_course_introduction'   => array(0,'Introduction to the TOHFL/Hebrew course'),
        'tohfl_course_part1'  => array(0,'TOHFL course Part-1'),
        'tohfl_course_part2'  => array(0,'TOHFL course Part-2'),
        'tohfl_course_exercise-index'  => array(0,'TOHFL course Exercise Index'),
    ),
