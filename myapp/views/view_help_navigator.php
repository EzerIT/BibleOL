...
$menu = array(
    ...
    'Teacher&rsquo;s Guide'  => array('teacher'          => array(0,'Features for teachers'),
                                      ...
                                      'create_exercises' => array(1,'Exercise management'),
                                      'create_exams'     => array(1,'Exam management'),
                                      'monitor_students' => array(1,'Monitor students'),
                                      'create/heb'       => array(2,'Hebrew: Create an Exercise'),
                                      'create2/heb'      => array(2,'Hebrew: Create an Advanced Exercise'),
                                      'create/gr'        => array(2,'Greek: Create an Exercise'),
                                      'create2/gr'       => array(2,'Greek: Create an Advanced Exercise'),
        ),
