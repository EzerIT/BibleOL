  ...
  <?php foreach($classes as $cl): ?>
    <tr>
      ...
      <td style="padding-left:5px;text-align:center;">
       <a class="badge badge-primary" href="<?= site_url('grades/teacher_exercises') ?>?classid=<?= $cl->id.($student?"&sid=".$this->mod_users->my_id():"") ?>"><?= $this->lang->line('grouped_by_exercises') ?></a>
     </td>
    </tr>
  <?php endforeach; ?>
  </table>
