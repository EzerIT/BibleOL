...
$lang['uc_edit_user'] = 'Edit user';  // Text in title bar
$lang['uc_edit_class'] = 'Edit class';  // Text in title bar
...
$lang['select_classes_for_user'] = 'Select the classes to which %s %s should belong.'; // First name, last name
$lang['users_in_class'] = 'Users in the Class \'%s\'';
$lang['classes_for_user'] = 'Classes for user \'%s\'';
$lang['user'] = 'User';
$lang['class'] = 'Class';
$lang['in_this_class'] = 'In this class?';
$lang['enroll_in_class'] = 'Enroll in Class'; // Text in title bar
