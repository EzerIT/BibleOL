...
$lang['file_mgmt'] = 'File Management';  // Text in title bar
$lang['create_folder'] = 'Create Folder';  // Text in title bar
$lang['delete_folder'] = 'Delete Folder';  // Text in title bar
$lang['copy_or_delete_files'] = 'Copy or Delete Files'; // Text in title bar
$lang['insert_files'] = 'Insert Files'; // Text in title bar
$lang['upload_files'] = 'Upload Files'; // Text in title bar
$lang['edit_visibility'] = 'Edit Visibility'; // Text in title bar
$lang['edit_visibility_button'] = 'Edit visibility'; // Button text
$lang['download_exercise'] = 'Download Exercise'; // Text in title bar
$lang['rename_exercise'] = 'Rename Exercise'; // Text in title bar
$lang['exercise_file_mgmt'] = 'Exercise File Management';
$lang['file_mgmt_description'] = 
    '<p>Here you can upload or delete exercise files, or you can create or delete folders for the
     files.</p>
...
$lang['cancel_copy_title'] = 'Cancel copy'; // Text in error title bar
$lang['upload_exercise_files1'] = 'Upload Exercise Files';
$lang['upload_exercise_files2'] =
    'You can generate exercise template files with the stand-alone Windows-based version of PLOTLearner.
     The exercise files have file type “.3et”.';
...
$lang['upload_exercise_files3_other'] =
    'Here, you can upload the exercise template files to the \'%s\' folder of this web site.';
$lang['upload_exercise_files4'] =
    'Click the “Upload files” button to the right to select files to upload. (In some browsers, you can
     also drag and drop files into the button.)';
...
$lang['select_folder'] = 'Here you can select which classes can see the exercises in the folder \'%s\'.';
...
$lang['delete_folder_button'] = 'Delete folder'; // Button text
$lang['delete_folder_confirm'] = 'Delete folder'; // Title in confirmation dialog
$lang['delete_folder_question'] = 'Do you want to delete the folder %s?';
$lang['folder_not_empty'] = 'Folder is not empty';
$lang['create_folder_button'] = 'Create folder'; // Button text
...
$lang['copy_files'] = 'Copy Files'; // Title in dialog heading
$lang['move_files'] = 'Move Files'; // Title in dialog heading
