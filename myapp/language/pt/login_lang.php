...
$lang['login']                   = 'Entrar';  // Text in title bar
$lang['login_button']            = 'Entrar';  // Button label
...
$lang['email_sent_msg']          = 'Um email contendo o seu nome de usuário e informação sobre como refazer a sua senha foi enviado para %s'; // Email address
$lang['cannot_reset_password']   = 'A Senha não pode ser refeita'; // Text in title bar
...
$lang['password_reset_sent']     = 'Um email contendo o seu nome de usuário e uma nova senha foi enviado para %s'; // Email address
...
$lang['new_google_user'] = 'Novo Usuário do Google'; // Text in title bar
...
$lang['no_email'] = 
    '<h1>Você não tem um endereço de email</h1>
...
$lang['warn_multiple_login'] =
    'Sempre utilize o mesmo mecanismo para entrar: Use sempre o Facebook, sempre o Google, ou sempre use
     um nome de usuário user name ou senha. Do contrário, você terá múltiplas congas neste sistema.';
