...
$lang['class'] = "Class";
$lang['class_uses_folder'] = "Class uses folder";
...
$lang['indicate_classes'] = "In the table below, indicate which classes use this folder. Only selected classes have access to the grading functionality under \"Grade Quizzes\". The class selection allows enrolled students to track their progress under \"My performance\".";
...
$lang['visibility_folder_desc'] = "Here you can select which classes can see the exercises in the folder '%s'. Students can check their performance for the contained exercises only if their class has been selected. This is also true for instructors. Instructors can only grade the contained exercises if they have selected the classes they teach.";
