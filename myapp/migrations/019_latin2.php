...
class Migration_Latin2 extends CI_Migration {
	...
	public function up() {
		$this->dbforge->add_column('translation_languages', array('latin2lex_enabled' => array('type'=>'tinyint(1)',
																							  'null' => false,
																							  'default' => 0)));


		echo "Create {$this->db->dbprefix}lexicon_latin2\n";
		...
		$this->dbforge->create_table('lexicon_latin2');
 
 
		echo "Remember to add data to {$this->db->dbprefix}lexicon_latin2\n";
    }
